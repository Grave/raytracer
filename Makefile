...
ifneq ($(DARWIN),) 
      LDFLAGS   := -Xlinker -rpath $(CUDA_LIB_PATH) -L$(CUDA_LIB_PATH) -lcudart -Wall 
...
ifneq ($(DARWIN),)
    ...
    LIBPATH_OPENGL  := -L../../common/lib/linux/$(OS_ARCH) -L/usr/X11R6/lib -lGL -lGLU -lX11 -lXi -lXmu -lglut ../../common/lib/linux/$(OS_ARCH)/libGLEW.a
endif
...
raytracer.o: raytracer.cpp sphere.h
	$(GCC) $(CCFLAGS) $(EXTRA_CCFLAGS) $(INCLUDES) -o $@ -c $<

raytracer_kernel.o: raytracer_kernel.cu
	$(NVCC) $(NVCCFLAGS) $(EXTRA_NVCCFLAGS) $(GENCODE_FLAGS) $(INCLUDES) -o $@ -c $<

raytracer: raytracer.o raytracer_kernel.o
...
clean:
	rm -f raytracer.o raytracer_kernel.o raytracer.bin raytracer
